...
class ClipMatcher(SetCriterion):
    ...
    def match_for_single_frame_not_use_id(self, outputs: dict, box_features, last_box_features):
        ...
        def return_min_cost(outputs, targets, outputs_index, targets_index, matcher):
            with torch.no_grad():
                ...
                # Final cost matrix
                C = self.matcher.cost_bbox * cost_bbox + self.matcher.cost_class * cost_class + self.matcher.cost_giou * cost_giou
