...
class DetMOTDetection:
    ...
    def sample_indices(self, vid, f_index):
        ...
        ids = [f_index +  i for i in range(self.sample_length)]
        ids = random.sample(ids, self.num_frames_per_batch)
        ids.sort() 
    ...
    def __getitem__(self, idx):
        ...
        images = images[:] + images[-3::-1]
        gt_instances = gt_instances[:] + gt_instances[-3::-1]
        return {
            'imgs': images,
